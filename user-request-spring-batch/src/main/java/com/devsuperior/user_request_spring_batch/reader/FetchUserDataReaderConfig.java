package com.devsuperior.user_request_spring_batch.reader;
...
import com.devsuperior.user_request_spring_batch.domain.ResponseUser;
...
public class FetchUserDataReaderConfig implements ItemReader<UserDTO> {
	...
	private List<UserDTO> fetchUserDataFromAPI() {
		...
		logger.info("[READER STEP] String uri " + String.format(uri, getPage(), pageSize));
